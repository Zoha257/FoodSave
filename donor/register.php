...
<head>
    ...
    <title>Donor Registration - FoodSave</title>
            ...
            <div class="col-md-8 col-lg-7">
                <div class="card mt-5 mb-4 shadow-lg" style="min-width: 650px; border-radius: 15px;">
                    <div class="card-header text-white text-center py-3" style="background: linear-gradient(45deg, #1a5d1a, #1e4d92);">
                        ...
                        <small class="fs-6">Register as a Food Donor (Restaurant, Grocery Store, Individual)</small>
                    </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-4">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name" required placeholder="Full Name / Organization Name *" style="padding: 12px 15px; font-size: 1.1rem;">
                                </div>
                            </div>
