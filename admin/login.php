...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            $pdo = getDBConnection();
            $stmt = $pdo->prepare("SELECT id, username, password, user_type, full_name FROM users WHERE username = ? AND user_type = 'admin' AND status = 'active'");
            ...
            <h2>Admin Login</h2>
                    ...
                    <?php endif; ?>
                        ...
                        <div class="text-center mt-4">
                            <a href="forgot_password.php" class="text-primary d-block mb-3" style="font-size: 1.1rem;"><i class="fas fa-key me-2"></i>Forgot Password?</a>
                            <a href="../index.php" class="d-block" style="font-size: 1.1rem; color: rgba(255, 255, 255, 0.9);"><i class="fas fa-home me-2"></i>Back to Home</a>
                        </div>
                </div>
            </div>
        </div>
