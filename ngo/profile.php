...
try {
    ...
    $stmt->execute([$_SESSION['user_id']]);
    $stats['completed_requests'] = $stmt->fetch(PDO::FETCH_ASSOC)['completed_requests'];
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0 text-black"><i class="fas fa-chart-bar"></i> My Activity</h5>
                            </div>
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-12 mb-3">
                                        <h3 class="text-success"><?php echo $stats['completed_requests']; ?></h3>
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <h5 class="mb-0 text-black"><i class="fas fa-info-circle"></i> Account Info</h5>
                            </div>
                            <div class="card-body">
                                <p><strong>Username:</strong> <?php echo htmlspecialchars($user['username']); ?></p>
                                <p><strong>User Type:</strong> <span class="badge bg-info">NGO</span></p>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0 text-black"><i class="fas fa-edit"></i> Edit Profile</h5>
                            </div>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="full_name" class="form-label">Organization Name *</label>
